    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, page.goto('https://admin.shopify.com/store/rubixteststore/apps/yozo-ai-staging')];
            case 4:
                // Navigate to the login page
                _a.sent();
                // Perform login actions
                return [4 /*yield*/, (0, login_1.login)(page)];
            case 5:
                // Perform login actions
                _a.sent();
                return [4 /*yield*/, page.goto('https://admin.shopify.com/store/rubixteststore/apps/yozo-ai-staging')];
            case 6:
                ...
                return [4 /*yield*/, page.context().storageState({ path: 'storageState.json' })];
            case 7:
                // Save the storage state to a file
                _a.sent();
